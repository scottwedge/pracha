                                ...
                                <div class="wow tada" style="visibility: visible; animation-name: tada;">
                                    <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                                        ...
                                        <div class="service_content">
                                            ...
                                            <p class="text-center">
                                                <a href="<?php echo base_url('web-development-company-in-hyderabad'); ?>" class="btn btn-warning btn-sm">Know more...</a> </p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class=" wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                                    <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                                        ...
                                        <div class="service_content">
                                            ...
                                            <p class="text-center">
                                                <a href="<?php echo base_url('mobile-app-development-company-in-hyderabad'); ?>" class="btn btn-warning btn-sm">Know more...</a> <!-- &nbsp;<span class="btn btn-warning btn-sm">View Packages</span>-->
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class=" wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeInUp; animation-delay: 0.2s;">
                                    <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                                        ...
                                        <div class="service_content">
                                            ...
                                            <p class="text-center">
                                                <a href="<?php echo base_url('ecommerce'); ?>" class="btn btn-warning btn-sm">Know more...</a> <!-- &nbsp;<span class="btn btn-warning btn-sm">View Packages</span>-->
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class=" wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-name: fadeInUp; animation-delay: 0.6s;">
                                    <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                                        ...
                                        <div class="service_content">
                                            ...
                                            <p class="text-center">
                                                <a href="<?php echo base_url('website_maintainence'); ?>" class="btn btn-warning btn-sm">Know more...</a></p>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="container-sty card ">
            ...
            <div class="row mobile-cus-support">
                ...
                <div class="col-sm-6 col-md-4 wow flipInX center" style="visibility: visible; animation-name: flipInX;">
                    <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                        <div class="service_details p-le0">
                            <h5 class=""><a href="#"> Marketing Support </a></h5>
                        </div>
                        <div class="service_content">
                            <p>

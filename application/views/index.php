   ...
   <section class=" bod-st" style="margin-top:75px;min-height:500px;">
      ...
      <!--Carousel Wrapper-->
	   ...
	   <div  class="col-md-4 ">
			...
			<div class=" py-2">
				<a href="" class="btn btn-success ">Click here to know more</a>
			</div>
	   </div>
	   </div>
   </section>
                        ...
                        <div class=" wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeInUp; animation-delay: 0.2s;">
                           <div class="service_box hi-icon-effect-3 hi-icon-effect-3b">
                              ...
                              <div class="service_content">
                                 ...
                                 <p class="text-center">
                     <a href="<?php echo base_url('ecommerce'); ?>"class="btn btn-warning btn-sm">Know more...</a> <!-- &nbsp;<span class="btn btn-warning btn-sm">View Packages</span>--></p>
                     </div>
                     </div>
                     </div></a>
                  </div>

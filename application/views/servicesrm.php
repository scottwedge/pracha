    ...
    <div class="container-sty card ">
        <div class="container-sty">
            ...
            <div class="row justify-content-md-center p-2">
                <h2 class=" col-md-12 text-warning font-bold">Web Designing Services :</h2>
            </div>

            <div class="row justify-content-md-center p-2">
                <h2 class="col-md-12 ">UI & UX</h2>
            </div>

            <div class="row justify-content-md-center p-2">

                <p class="col-md-12"> User Interface Design is the combination of Visual Design and Interaction Design. Visual Design is the look and feel of the site, and Interaction Design is the way public interacts with your site. Under UI and UX Design, we focus on the core functions like Site Architecture and Design, Static & Dynamic Website Design, Responsive Web Design, Custom Web Design, Template Design & Customization etc., let’s have a glimpse on these attributes and their functionalities. </p>
                ...
                <div class="container-sty">
                    ...
                    <div class="tab-content">
                        ...
                        <div class=" active">
                            ...
                            <hr class="mb-4 mt-4 pb-3" id="static-and-dynamic-website-design">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <!--Featured image-->
                                    <div class=" overlay hm-white-slight rounded z-depth-2">
                                        <img src="<?php echo base_url(); ?>assets/vendor/img/custom-web-design.png" title="Custom Web Design" alt="Custom Web designing agency in hyderabad" class="img-fluid">
                                        <a>
                                            <div class="mask"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-4">
                                    <!--Featured image-->
                                    <div class="overlay hm-white-slight rounded z-depth-2">
                                        <img src="<?php echo base_url(); ?>assets/vendor/img/template-design-and-customization.png" title="Website Templates" alt="Template web designing agency in hyderabad" class="img-fluid">
                                        <a>
                                            <div class="mask"></div>
                                        </a>
                                    </div>
...
<section class="py-4">
    <div class="container-sty card ">
        ...
        <div class="row text-center py-4">
            ...
            <p class="text-left font-bold col-md-10  "> We not only design stunning websites but also implement various SEO techniques for our clients, for better rankings in Google. “Keyword” plays a major role in SEO, and it is must to identify the targeted keywords.</p>
        </div>
        ...
        <div class="container-sty">
            ...
            <div class="row p-3 pt-2">
                <div class="col-md-5">
                    <div data-wow-iteration="2" class="mb-r center-on-small-only wow swing center" style="visibility: visible; animation-iteration-count: 2; animation-name: swing;"> 
                        <br>
                        <br>
                        <img src="<?php echo base_url(); ?>assets/vendor/img/lsi-web-agency.png" title="Search Keywords " alt="searching keywords" class="img-fluid">
                    </div>
                </div>
                <!--Grid column-->
...
<section class="">
    <div class="container-sty card ">
        ...
        <div class="container-sty">
            <!--Grid row-->
            <div class="row p-3 pt-2">
                <div data-wow-iteration="2" class="col-lg-5 mb-2 center-on-small-only wow swing center" style="visibility: visible; animation-iteration-count: 2; animation-name: swing;">
                    <br>
                    <br>
                    <br>
                    <br>

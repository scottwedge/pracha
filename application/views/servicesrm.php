    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-1-font fa fa-globe"></div>
          <div class="price color-1-font"><span class="total">Alpha</span></div>
          <div class="description">1-4 Page<pre class="price-ani text-dark">₹ 6,999</pre></div>
         
        </div><!-- end div .front -->
        <div class="popular color-1-font  fa fa-globe"></div>

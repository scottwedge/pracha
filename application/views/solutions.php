...
<ul class="nav md-pills nav-justified pills-primary">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel13" role="tab">Link3</a>
    </li>
	  <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel14" role="tab">Link4</a>
    </li>
	  <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel15" role="tab">Link5</a>
    </li>
	  <li class="nav-item">
...
<div class="tab-content">
    ...
    <!--Section description-->
    <p class="text-center mb-5 pb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>

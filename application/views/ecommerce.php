...
<div class="view jarallax height-600" data-jarallax='{"speed": 0.2}' style="background-image: url(<?php echo base_url(); ?>assets/vendor/img/wide-range.png); ">
    <div class="full-bg-img">
      <div class=" ">
		...
		<div class="col-md-10">
				<h2 class="py-4 font-weight-bold text-text" style="font-size:30px;line-height:40px;">SERVICES THAT WE OFFER
				</h2>
				<p class="font-w-400 text-shadow" style="font-style:normal">Our eCommerce service includes: CRM, ERP & PIM Integration, Automatic Inventory Control, Readymade Store Fronts, POS and Supply Relationship Management, Coupons and Offers, Payment Gateway Integration, Mobile Content Management and many more,.
				</p>
				</div>
		</div>

            ...
            <div class="col-sm-12 mb-20 pt-30">
                ...
                <h2>
                    <span class="tit bg-white" >
									Maintainence <span class="des_t"> Monthly
                    </span> Pricing 
                </h2>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          ...
          <div class="description">5 Hours/Month	 <pre class="price-ani ">₹ 4,999</pre></div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          ...
          <div class="description"> 10 Hours/Month<pre class="price-ani ">₹ 9,999</pre></div>
        </div><!-- end div .front -->
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          ...
          <div class="description">20 Hours/Month<pre class="price-ani ">₹ 19,999</pre></div>
        </div><!-- end div .front -->
...
<section class="content_wrap  jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('<?php echo base_url(); ?>assets/vendor/img/bac1.png'); height: 500px;" >
  ...
  <div class="row  text-center">
            <div class="col-sm-12 mb-20 pt-30">
                ...
                <h2>
                    <span class="tit bg-white" >
									Maintainence   <span class="des_t">Quarter ( 3 Months )
                    </span> Pricing 
                </h2>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-1-font fa fa-hand-o-down"></div>
          <div class="price color-1-font"><span class="total">Alpha</span></div>
          <div class="description"> 5 Hours/Month<pre class="price-ani ">₹ 14,549</pre></div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-2-font fa fa-hand-o-down"></div>
          <div class="price color-2-font"><span class="total">BETA</span></div>
          <div class="description"> 10 Hours/Month<pre class="price-ani ">₹ 29,099</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-2-font fa fa-hand-o-right"></div>
        <div class="back color-2-bg info">
          <div class="title">BETA</div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-3-font fa fa-hand-o-down"></div>
          <div class="price color-3-font"><span class="total">GAAMA</span></div>
          <div class="description">20 Hours/Month	<pre class="price-ani ">₹ 58,199</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-3-font fa fa-hand-o-right"></div>
        <div class="back color-3-bg info">
          <div class="title">GAAMA</div>
...
<section class="content_wrap  jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('<?php echo base_url(); ?>assets/vendor/img/bac2.png'); height: 500px;" >
  ...
  <div class="row  text-center">
            <div class="col-sm-12 mb-20 pt-30">
                ...
                <h2>
                    <span class="tit bg-white" >
									Maintainence <span class="des_t"> Half Year( 6 Months )
                    </span> Pricing 
                </h2>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-1-font fa fa-hand-o-down"></div>
          <div class="price color-1-font"><span class="total">Alpha</span></div>
          <div class="description">5 Hours/Month <pre class="price-ani ">₹ 28,500</pre></div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-2-font fa fa-hand-o-down"></div>
          <div class="price color-2-font"><span class="total">BETA</span></div>
          <div class="description">10 Hours/Month <pre class="price-ani ">₹ 56,999</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-2-font fa fa-hand-o-right"></div>
        <div class="back color-2-bg info">
          <div class="title">BETA</div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-3-font fa fa-hand-o-down"></div>
          <div class="price color-3-font"><span class="total">GAAMA</span></div>
          <div class="description">20 Hours/Month<pre class="price-ani ">₹ 11,3999</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-3-font fa fa-hand-o-right"></div>
        <div class="back color-3-bg info">
          <div class="title">GAAMA</div>
...
<section class="content_wrap  jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('<?php echo base_url(); ?>assets/vendor/img/bac3.png'); height: 500px;" >
  ...
  <div class="row  text-center">
            <div class="col-sm-12 mb-20 pt-30">
                ...
                <h2>
                    <span class="tit bg-white" >
									Maintainence <span class="des_t"> Annual( 12 Months )
                    </span> Pricing 
                </h2>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-1-font fa fa-hand-o-down"></div>
          <div class="price color-1-font"><span class="total">Alpha</span></div>
          <div class="description">12 Hours/Month <pre class="price-ani ">₹ 55,799</pre></div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-2-font fa fa-hand-o-down"></div>
          <div class="price color-2-font"><span class="total">BETA</span></div>
          <div class="description">10 Hours/Month <pre class="price-ani ">₹ 1,11,599</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-2-font fa fa-hand-o-right"></div>
        <div class="back color-2-bg info">
          <div class="title">BETA</div>
    ...
    <li>
      <div class="circle">
        <div class="front front-popular">
          <div class="title color-3-font fa fa-hand-o-down"></div>
          <div class="price color-3-font"><span class="total">GAAMA</span></div>
          <div class="description">20 Hours/Month<pre class="price-ani ">₹ 2,23,199</pre></div>
        </div><!-- end div .front -->
        <div class="popular color-3-font fa fa-hand-o-right"></div>
        <div class="back color-3-bg info">
          <div class="title">GAAMA</div>

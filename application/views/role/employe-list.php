...
<div class="container-sty-adm ">
    <div class="col-md-12 ">
        <h3 class=" text-center" >  Role Wise Employee List</h3>
        <hr>
    </div>
        ...
        <div class="col-md-9   mar_t20 mx-0  table-responsive">
            ...
            <table id="example" class="table table-striped table-bordered table-responsive-md" cellspacing="0" width="100%">
                ...
                <thead>
				  ...
				  <tbody>
				  <?php if(isset($employee_role_list) && count($employee_role_list)>0){ ?>
				  <?php foreach($employee_role_list as $list){?>
					<tr>
						<td><?php echo isset($list['role'])?$list['role']:''?></td>
						<td><?php echo isset($list['employe_name'])?$list['employe_name']:''?></td>
						...
						<td>
						 ...
						 <a  class="btn btn-warning btn-sm my-0 waves-effect waves-light my-2" href="<?php echo base_url('employee/editemployee/'.base64_encode($list['r_w_id'])); ?>"  data-toggle="tooltip" title="Edit" >Edit</a>
							
						<a href="<?php echo base_url('employee/employeedelete/'.base64_encode($list['r_w_id'])); ?>" class="btn btn-danger btn-sm my-0 waves-effect waves-light">Delete</a>
						</td>
					</tr>
                </tbody>
				  <?php }?>

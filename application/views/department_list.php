            ...
            <table id="example" class="table table-striped table-bordered table-responsive-md" cellspacing="0" width="100%">
                ...
                <?php foreach ($list as $lis){ $count=1; ?>
                    <tr>
                        ...
                        <td><?php echo $lis->department_name; ?> </td>
                        ...
                        <th>
                            ...
                            <a class="text-warning" href="<?php echo base_url('department/department_edit/'.base64_encode($lis->department_id)); ?>">
                                Edit</a> |
                            <a class="text-warning" href="<?php echo base_url('department/department_status/'.base64_encode($lis->department_id).'/'.base64_encode($lis->status)); ?>">
                                <?php if($lis->status==2){ echo "Active" ;}else{ echo "Deactive"; } ?></a> | <a class="text-warning"
                                                                                                                href="<?php echo base_url('department/delete_department/'.base64_encode($lis->department_id).'/'); ?>">Delete</a></th>

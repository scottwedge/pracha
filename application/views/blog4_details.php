    ...
    <section class="pt-5 mt-4 pb-3 pargh">
        ...
        <div class="row justify-content-md-center   ">
			...
			<div class="row pb-3">
				...
				<p><h2>Mobile Commerce (m-Commerce):  </h2>Mobile Commerce is the buying and selling of goods or services especially through mobiles. A research regarding mobile commerce has declared that more than 70% of the online  transactions are done through mobiles, mobile commerce has captured the customer as well as the market share. Best examples are mobile banking, mobile ticketing, mobile payments, mobile vouchers and coupons  etc. </p>

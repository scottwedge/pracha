...
<section id="masthead" role="banner" class="bod-st">
  ...
  <h1>
   MOBILE APPLICATIONS <br />
	<br>
	<p  style="font-size:10px;" class="typewrite pulse" data-period="2000" data-type='[ "IOS Application Development", "Android Application Development", "Mobile Application Strategy & Development","User Experience & Interface Design","Mobile Integration","Mobile Testing & Security","Support Maintenance","Full Stack Services",  " " ]'>
            ...
            <div class="serviceBox orange">
                ...
                <div class="service-content">
                    ...
                    <ul class="description text-left plr-20" >
						<li>Building strategy based on requirements</li>
						<li>Identify your target audience</li>
						<li>Leverage advances on technology</li>
            ...
            <div class="serviceBox blue">
                ...
                <div class="service-content">
					...
					<ul class="description text-left plr-20" >
						...
						<li>Attractive UI Design for Mobile applications</li>
            ...
            <div class="serviceBox green">
                ...
                <div class="service-content">
					...
					<ul class="description text-left plr-20" >
						...
						<li>Gateways integration </li>
						<li>Integrate with ecosystem of mobile and web applications</li>
        ...
        <div class="col-md-3 col-sm-6 col-xsx-6">
            <div class="serviceBox blue">
                ...
                <div class="service-content">
					...
					<ul class="description text-left plr-20" >
						<li>Deployment to App store or Play store</li>
						<li>Update releasing</li>
            ...
            <div class="serviceBox">
                ...
                <div class="service-content">
                    <h3 class="title">Full Stack Services </h3>
						...
						<li>Frontend, Middleware & Backend for mobile & web Apps</li>
						<li>Full stack Website& Mobile application building</li>

...
<section class="py-4 text-center text-lg-left  " id="servic">
	<div class="container-sty card ">
		                            
<ul class="nav md-pills nav-justified pills-primary">
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#panel4" role="tab">UI/UX DESIGNING</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel11" role="tab">WEB DEVELOPMENT</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel12" role="tab"> MOBILE APPLICATIONS </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel13" role="tab">DIGITAL MARKETING & SEO</a>
    </li>
	  <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel14" role="tab">E-COMMERCE DEVELOPMENT</a>
    </li>
	  <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel15" role="tab">BUSINESS SOLUTIONS</a>
    </li>
	  <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#panel16" role="tab">Link6</a>
    </li>
</ul>
</div>
...
Our expert in-house team uses cutting edge technologies to build custom web applications that are stunning, robust, secure and scalable and we follow agile development methodology to ensure flexibility and faster delivery</p>
		<hr class="mb-5 mt-5 pb-3">
    <div class="row">
    ...
    <div class="tab-pane fade" id="panel12" role="tabpanel">
        <br>
			<!--Grid row-->
			 <h1 class="h1 font-bold text-center ">SERVICES</h1>
    <!--Section description-->
    <p class="text-center mb-5 pb-3">prachaTECH has been dedicatedly involved in the development of user-centric mobile applications. Our services have achieved a dignified niche in the global mobile application development spectrum. We are committed to develop quality applications.</p>
		<hr class="mb-5 mt-5 pb-3">
    <div class="row">
    ...
    <div class="tab-pane fade" id="panel13" role="tabpanel">
        <br>
			<!--Grid row-->
			 <h1 class="h1 font-bold text-center ">SERVICES</h1>
    <!--Section description-->
    <p class="text-center mb-5 pb-3">Excel business with perfect online presence--For getting a better graph in business, there must be a dedicated team working on it. prachaTECH has the perfect SEO team that works exceptionally well on a variety of techniques for augmenting the online presence of the client’s business websites. We are renowned to offer the complete online marketing services.</p>
		<hr class="mb-5 mt-5 pb-3">
    <div class="row">
    ...
    <div class="tab-pane fade" id="panel14" role="tabpanel">
		<br>
			<!--Grid row-->
			 <h1 class="h1 font-bold text-center ">SERVICES</h1>
    <!--Section description-->
    <p class="text-center mb-5 pb-3">The e-commerce industry is constantly on the rise, each year we are seeing profits increase by an average of 14%. Business owners must act quickly to leverage emerging opportunities. Find success with custom e-commerce software development that provides the customer-oriented solution you need to meet your business goals and objectives.</p>
		<hr class="mb-5 mt-5 pb-3">
    <div class="row">
    ...
    <div class="tab-pane fade" id="panel15" role="tabpanel">
		<br>
			<!--Grid row-->
			 <h1 class="h1 font-bold text-center ">SERVICES</h1>
    <!--Section description-->
    <p class="text-center mb-5 pb-3">Pre- developed, Tailor-Made & Customizable, Professional, Affordable & Effective Business Solutions. We deliver A-level solutions to our clients in e-commerce, finance, education management, hotels & restarunts, healthcare & other industries</p>
		<hr class="mb-5 mt-5 pb-3">
    <div class="row">

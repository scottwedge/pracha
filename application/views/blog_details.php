            ...
            <div class="col-md-10 card  pad-lr15">
                    ...
                    <div class="col-md-12   ptb-15">
                        ...
                        <div class=" ">
                            ...
                            <div class=" view overlay card " style="margin-top:50px;">
                                <img src="<?php echo base_url(); ?>assets/vendor/img/blog.png" alt="know how to optimize a youtube channel" class="img-fluid">
                                <a>
                ...
                <div class="row">
                    <div class="col-md-10 mb-20 pt-30 ">
                        <h2 class="text-left">
                            <span class="tit1">How to Create a Youtube Channel?</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="row ">
                    <div class="col-md-10 mb-20 pt-30 ">
                        <h2 class="text-left">
                            <span class="tit1 ">How to manage accounts on the Youtube Channel?
                            </span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-12 mb-20 pt-30  ">
                        <div class="row ">
                            <div class="col-md-10 mb-20 pt-30 ">
                                <h2 class="text-left">
                                    <span class="tit1">Features of Youtube:</span>
                                </h2>
                            </div>
                        </div>
                        <div class="row justify-content-md-center ">
                    ...
                    <div class="col-md-12 mb-20 pt-30  ">
                        <div class="row ">
                            <div class="col-md-10 mb-20 pt-30 ">
                                <h2 class="text-left">
                                    <span class="tit1">How to Optimize a Video on Youtube?</span>
                                </h2>
                            </div>
                        </div>
                        <div class="row justify-content-md-center ">
                ...
                <div class="row ">
                    <div class="col-md-10 mb-20 pt-30 ">
                        <h2 class="text-left">
                            <span class="tit1">How Youtube ranks your video?</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="row pad30 justify-content-md-center">
                    <div class="col-md-8">
                        <form class="form-horizontal" action="<?php echo base_url('blog/addcomment');?>" method="post">
                            <input type="hidden" id="p_id" name="p_id" value="1">
                            ...
                            <div class="news">
                                ...
                                <div class="excerpt">
                                    ...
                                    <div class="feed-footer">
                                        ...
                                        <span>
                                            <a>
                                                <?php echo count($list['count']); ?></a>
                                        </span>
                                        <?php } ?>
                                        <a class="thumbs" data-toggle="tooltip" data-placement="top" onclick="likecounts('<?php echo $list['id']; ?>');" title="I like it">
                                            <i class="fa fa-thumbs-up"><span id="countids<?php echo $list['id']; ?>">
                                                    <?php echo $list['likecount']; ?></span></i>
                                        </a>

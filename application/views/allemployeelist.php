...
<div class="container-sty-adm ">
	<div class=" row justify-content-md-end ">
		...
		<a  href="<?php echo base_url('employee/allemployees'); ?>" type="button" class="btn btn-info btn-rounded pull-right">Add</a>
		...
		<?php endif; ?>
			...
			<?php foreach($employee_list as $elist){ ?>
				<tr>
					...
					<td><a href="<?php echo base_url('employee/allemployeeedit/'.base64_encode($elist['emp_id'])); ?>">Edit</a>
					|<a href="<?php echo base_url('employee/allemployeestatus/'.base64_encode($elist['emp_id']).'/'.base64_encode($elist['status'])); ?>"><?php if($elist['status']==1){ echo "Deactive"; }else{ echo "Active"; } ?></a>
					|<a href="<?php echo base_url('employee/alltaskexport/'.base64_encode($elist['emp_id'])); ?>">Work Export</a>
					</td>
				</tr>
			<?php } ?>

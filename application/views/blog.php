...
<section class="pt-5 mt-4 pb-3 pargh">
        ...
        <div class="col-md-12   ptb-15">
			...
			<p>If you have the desire to attract audience attention across the world with your creative ideas and videos, then this article is for you.</p>
                ...
                <div class=" view overlay card " style="margin-top:50px;">
                    <img src="<?php echo base_url(); ?>assets/vendor/img/blog.png" alt="blog" class="img-fluid">
                    <a>
	...
	<div class="col-md-10 mb-20 pt-30 ">
		<h2 class="text-left">
		<span class="tit1">How to Create a Youtube Channel?</div>
		</h2>
	</div>
	...
	<div class="row justify-content-md-center">
		...
		<div class="col-md-12">
			...
			<div class="row pb-3">
				...
				<p>
					Basing on the research result you need to come with your video presentation.
					Never give a long introduction about your company or product. Let your video be specific and short, so that viewer won't be bored and there will be a chance for your viewer to maintain long-term relation with your channel.
				</p>
		</div>
		...
		<div class="col-md-12 mb-20 pt-30  ">
			<div class="row justify-content-md-center ">
				<div class="col-md-12">
					...
					<p> <span class="font20 text-dark">Title: </span><br> Your title describes your video, so include your keyword only once in the title column. Make sure to include the word ‘video’ in your title. Even it is good to imagine keywords in viewers prospect, else check your competitors sites .
					</p>
					<p> <span class="font20 text-dark">Description:</span> <br>Describe your video, and add your keywords once or twice in this column. Make sure to mention your website or blog so that it will be considered as a backlink, and an advantage for Google ranking, and even you can capture email addresses, and know who have logged into your site.
					</p>
	...
	<div class="col-md-10 mb-20 pt-30 ">
		<h2 class="text-left">
		<span class="tit1">How Youtube ranks your video?</div>
		</h2>
	</div>
	...
	<!--
	 ...
	 <div class="bg-dark " style="padding:15px;margin:0">
		...
		<div class="col-md-1">
			...
			<div class="col-md-3">
				<input class="input-old" type="text" placeholder="Name" id="" class="form-control">
			</div>
			<div class="col-md-3">
				<input class="input-old" type="email" placeholder="Email Id" id="" class="form-control">
			</div>
			<div class="col-md-3">
				<input class="input-old" type="text" id="" placeholder="Mobile"  class="form-control">
			</div>
			<div class="col-md-2">
            ...
            <div class="mdb-feed">
                            ...
                            <div class="collapse" id="collapseExample-1">
                                <div class="card card-body mt-1">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#collapseExample-1" aria-expanded="false"
                                            aria-controls="collapseExample-1">Reply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="news">
                    ...
                    <div class="excerpt">
                        ...
                        <div class="added-images">
                            <img src="https://mdbootstrap.com/img/Photos/Others/images/50.jpg" class="z-depth-1 rounded">
                        ...
                        <div class="feed-footer">
                            ...
                            <div class="collapse" id="collapseExample-2">
                                <div class="card card-body mt-1">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn-flat waves-effect" data-toggle="collapse" data-target="#collapseExample-2" aria-expanded="false"
                                            aria-controls="collapseExample-2">Cancel</button>
                                        <button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#collapseExample-2" aria-expanded="false"
                                            aria-controls="collapseExample-2">Reply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="feed-footer">
                            ...
                            <div class="collapse" id="collapseExample-3">
                                <div class="card card-body mt-1">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn-flat waves-effect" data-toggle="collapse" data-target="#collapseExample-3" aria-expanded="false"
                                            aria-controls="collapseExample-3">Cancel</button>
                                        <button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#collapseExample-3" aria-expanded="false"
                                            aria-controls="collapseExample-3">Reply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="news">
                    ...
                    <div class="excerpt">
                        ...
                        <div class="added-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero inventore, iste quas libero eius?
                            Vitae sint neque animi alias sunt dolor, accusantium ducimus, non placeat voluptate.</div>
                            ...
                            <div class="collapse" id="collapseExample-4">
                                <div class="card card-body mt-1">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#collapseExample-4" aria-expanded="false"
                ...
                <div class="news">
                    ...
                    <div class="excerpt">
                        ...
                        <div class="added-images">
                            <img src="https://mdbootstrap.com/img/Photos/Others/images/81.jpg" class="z-depth-1 rounded">
                        ...
                        <div class="feed-footer">
                            ...
                            <div class="collapse" id="collapseExample-5">
                                <div class="card card-body mt-1">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn-flat waves-effect" data-toggle="collapse" data-target="#collapseExample-5" aria-expanded="false"
                                            aria-controls="collapseExample-5">Cancel</button>
                                        <button type="button" class="btn btn-warning" data-toggle="collapse" data-target="#collapseExample-5" aria-expanded="false"
                                            aria-controls="collapseExample-5">Reply</button>
                                    </div>
                                </div>
                            </div>
                        </div>

...
<div class="container-sty card " >
		<div class="row  text-center">
            <div class="col-sm-12 mb-20 pt-30">
                ...
                <h2>
                    <span class="tit">
									WEB<span class="des_t"> DEVELOPMENT  </span> SERVICES
                    </span>
                </h2>
	...
	<td class="tabco4">17-25 Pages </td>
	...
	<td class="tabco4" >Extra Creative Web Design</td>
	</tr>
	<tr>
	...
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i>(editable)</td>
	...
	<td class="tabco4" >5 Email Id	</td>
	<td class="tabco4" >7 Email Id</td>
	

	</tr>

	<tr>
	<td class="tabco1" ><h5>1 Inquiry Page</h5></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	...
	<tr>
		<td class="tabco1" ><h5>Editable Content</h5></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	...
	<tr>
		<td class="tabco1" ><h5>Search Engine Friendly</h5></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
	...
	<tr>
		...
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-check rightSign" aria-hidden="true">(Unlimited)</i></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tabco1" ><h5>Parallex</h5></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
	...
	<tr>
		<td class="tabco1" ><h5>Back End Entry</h5></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
	...
	<tr>
		<td class="tabco1" ><h5>Multiple Forms</h5></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
	...
	<tr>
		...
		<td class="tabco4" >After 15 Pages Per page Rs.500(Without form)</td>
		<td class="tabco4" ><i class="fa fa-times crossSign" aria-hidden="true"></i></td>
	</tr>
